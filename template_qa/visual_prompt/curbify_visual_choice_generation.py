...
from visual_prompt import VisualPromptGenerator
import traceback
import time
...
def template_qa_generation(frame_dir, template_name):
    ...
    image_path = data["image_resized_path"]

    qa_pairs = prompt_generator.evaluate_predicates_on_pairs(detections, image_path, gt_depth_path, wide_depth_path)
    result = {
